...
// This program should run correctly with your Substitute and Add128 classes.
// Use it to test them before incorporating them into your overall secure
// client.  Your output should be similar to that shown in file ciphertest.txt
// (the hard coded values should match exactly but the generated bytes will
// be different since the keys are random)
...
public class SymCipherTest
{
	public static void main (String [] args)
	{
		...
		// and on Windows, we will limit our Strings to "regular" ASCII (up to 127).
		...
		// Build a long String to make sure Add128 will work when the
		// String is longer than the key
